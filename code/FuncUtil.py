...
if __name__ == '__main__':
    func = "function withdraw(uint amount) { if (credit[msg.sender]>= amount) {msg.sender.call.value(amount)();credit[msg.sender]-=amount;}} "
    node_feature, edge_feature = generate_graph(func)
    print(node_feature)
    print(edge_feature)
